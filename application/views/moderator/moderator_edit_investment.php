...
<div class="content_fullwidth less2">
	<div class="container">
		<div id="pencere" class="logregform two">
			...
			<div class="feildcont">
			<?php echo form_open(base_url('moderator/edit_investment'),array('role' => "form",'method'=>"post",'enctype'=>"multipart/form-data" ));?>				
				   ...
				   <!-- Qısa Məlumat -->
                     ...
                     <!--Layihənin üstünlükləri --> 
				          <div class="col-md-12">
						<label for="projectName">Layihənin üstünlükləri(<?php echo $translation_row['lang_code']; ?>)</label>
						<textarea name="main_advantages_<?php echo $translation_row['lang_code']; ?>" class="comment_textarea_bg" style=" width:100%; border: 1px solid #e3e3e3;" ><?php echo $translation_row['main_advantages']; ?></textarea></div>
						</div>
				   <div class="clearfix"></div>
					<div class="margin_bottom2"></div>
<?php }?>
				...
				<!--Investisiya hecmi -->  
				 ...
				 <div class="col-md-6 col-xs-12">
						...
						<input type="number" name="investment_percent" required  value="<?php echo $detail['investor_percent']; ?>"/>
						</div>
