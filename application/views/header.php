...
?>
<!doctype html>
<html lang="<?=$lang?>" class="no-js" data-accw-position="bottom-left" data-accw-offsett="none">
           <head>
					<meta charset="UTF-8">
        ...
        <div class="site_wrapper">
                ...
                <ul class="toplinks">
                    ...
                    <?php
                   	if ($this->session->userdata('is_moderator')) {
                   		echo '<li><a href="'.base_url($lang).'/moderator/on_waiting_projects"><i class="fa fa-sign-in"></i> '.translate('Moderator').' &nbsp;&nbsp;</a></li>';
                   	}elseif (!$this->session->userdata('user_id')) {
                    	echo '<li><a href="'.base_url($lang).'/user/login"><i class="fa fa-sign-in"></i> '.translate('login').'</a></li>';
             			echo '<li><a href="'.base_url($lang).'/user/register"><i class="fa fa-user"></i> '.translate('sign_up').' &nbsp;&nbsp;</a></li>';
                  	}else{
                   		echo '<li><a href="'.base_url($lang).'/user/profile"><i class="fa fa-sign-in"></i> '.translate('profile').' &nbsp;&nbsp;</a></li>';
                  	}
	                
	                if ($lang === 'az') {
						?>
						<li><a href="<?= lang_url('en') ?>">EN</a></li>
						<li><a href="<?= lang_url('ru') ?>">RU</a></li>
                   		<?php 
                   	}if($lang === 'ru'){
                   		?>
						<li><a href="<?= lang_url('az') ?>">AZ</a></li>
						<li><a href="<?= lang_url('en') ?>">EN</a></li>
						<?php 
					}if($lang === 'en'){
						?>
            ...
            <header class="header">
                <div class="container_full_menu">
                    <!-- Logo -->
                    <div class="logo"><a href="<?php echo base_url($lang); ?>" id="logo"></a></div>
                    <!-- Navigation Menu -->
                    <div class="menu_main">
                            ...
                            <div id="navbar-collapse-1" class="navbar-collapse collapse pull-right">
                                <nav>
                                    <ul class="nav navbar-nav">
										...
										-->
                                        <li><a class="dropdown-toggle" href="<?php echo base_url($lang); ?>" title="<?php echo translate('home_page');?>"><i class="fa fa-home fati20"></i></a></li>
                                        <li class="dropdown"><a href="<?php echo base_url($lang);?>/geomap" class="dropdown-toggle <?php if($this->uri->segment(1)==='geomap'){echo 'active';}?>" title="<?php echo translate('geo-ecicial_map');?>"><?php echo translate('geo-ecicial_map');?></a></li>
...
<<<<<<< HEAD
		                                        <li><a href="<?php echo base_url($lang); ?>/about" class="dropdown-toggle" title="<?php echo translate('portal_profile');?>"><?php echo translate('portal_profile');?></a></li>
		                                        <!-- <li><a href="<?php echo base_url($lang); ?>/strategic-plan" class="dropdown-toggle" title="<?php echo translate('strategic-plan');?>"><?php echo translate('strategic-plan');?></a></li> -->
		                                        <li><a href="<?php echo base_url($lang); ?>/contact" class="dropdown-toggle" title="<?php echo translate('contact');?>"><?php echo translate('contact');?></a></li>
=======
...
<<<<<<< HEAD
                                                <li class="dropdown"><a href="<?php echo base_url($lang);?>/home/documents" class="dropdown-toggle <?php if($this->uri->segment(2)==='documents'){echo 'active';}?>" title="<?php echo translate('doc_header');?>"><?php echo translate('doc_header');?></a></li>
                                                <li><a href="<?php echo base_url($lang);?>/home/doingbusiness/8-biznese-baslama" class="dropdown-toggle" title="<?php echo translate('Why_Azerbaijan');?>"><?php echo translate('Why_Azerbaijan');?></a></li>
											</ul>
										</li>
										<li class="dropdown"><a href="<?php echo base_url($lang);?>/project/all" class="dropdown-toggle <?php if($this->uri->segment(2)==='projects'){echo 'active';}?>" title="<?php echo translate('projects');?>"><?php echo translate('projects');?></a></li>
=======
...
>>>>>>> 4cc5aa09946e2d7d90543c375f38a44cdd79c424
                                        ...
                                        <li class="dropdown"><a href="#" class="dropdown-toggle <?php if($this->uri->segment(2)==='news' OR $this->uri->segment(1)==='video'){echo 'active';}?>" title="<?php echo translate('media_new');?>"><?php echo translate('media_new');?><i class="fa fa-sort-desc"></i></a>
											<ul class="dropdown-menu" role="menu">
												<li><a href="<?php echo base_url($lang);?>/news" class="dropdown-toggle" title="<?php echo translate('news');?>"><?php echo translate('news');?></a></li>
												<li><a href="<?php echo base_url($lang);?>/video" class="dropdown-toggle" title="<?php echo translate('videos');?>"><?php echo translate('videos');?></a></li>
											</ul>
										</li>

										<li><a href="<?php if(!$this->session->userdata('user_id')){ echo base_url($lang.'/user/login?return='.$lang.'/user/categories');}else{echo base_url($lang.'/user/categories');}?>" class="buynowbut" title="<?php echo translate('add_new_project');?>" ><b>+</b> <?php echo translate('add_new_project');?></a></li>
