            ...
            <div>
                    ...
                    <a href="https://startupschool.az/">
                        <div class="slider-box">
                            <div class="icon-wrapper">
                                <img src="<?php echo base_url(); ?>assets/front/images/cap.svg" alt="icon"/>
                            </div>
                ...
                <div>
                    <a href="<?= base_url('project/category/5-ideyalar') ?>">
                        <div class="slider-box">
                            <div class="icon-wrapper">
                                <img src="<?php echo base_url(); ?>assets/front/images/lightbulb.svg" alt="icon"/>
                            </div>
                            <div class="slider-box-content">
                ...
                <div>
                    <a href="<?= base_url('project/category/1-startap') ?>">
                        <div class="slider-box">
                            <div class="icon-wrapper">
                                <img src="<?php echo base_url(); ?>assets/front/images/rising_arrow.svg" alt="icon"/>
                            </div>
                            <div class="slider-box-content">
                ...
                <div>
                    <a href="<?= base_url('project/all') ?>">
                        <div class="slider-box">
                            <div class="icon-wrapper">
                                <img src="<?php echo base_url(); ?>assets/front/images/wallet.svg" alt="icon"/>
                            </div>
                            <div class="slider-box-content">
                            ...
                            <div class="slide active"
                                ...
                                <div class="slide-content">
                                    ...
                                    <div style="padding-top:17px;">
                                        <a href="<?php echo base_url(); ?>news/detail/<?php echo $item['id'] . '-' . $item['top_' . $l . '']; ?>"
                                           class="btn-more"><?php echo translate('home_more_info'); ?> →</a>
                                    </div>
                                </div>
                            </div>
                        <?php endforeach ?>
                            ...
                            <div class="owl-item video-container">
                                <div class="news-element-yn video-item">
                                    <div class="video-item-cover-container">
                                        <img class="photo-yn video-item-cover"
                                            ...
                                            <div class="play-icon">
                                                <a href="<?= base_url($lang); ?>/video/detail/<?= $row['v_id'] ?>">
                                                    <img style="width:70px;height:70px;margin-right:6px;"
                                                         src="<?php echo base_url(); ?>assets/front/icons/play_icon.svg"
                                                         alt="calendar"/>
                                                </a>
                                            </div>
                                        </div>
                                        <div class="news-text-yn"
                                            ...
                                            <p class="text-yn video-item-text"><a
                                                        href="<?= base_url($lang); ?>/video/detail/<?= $row['v_id'] ?>"><?= qisalt($row['v_title_' . $l . ''], 130); ?></a>
                                            </p>
                                            <div class="date-sign-yn" style="gap:10px;">
                                                <div style="display:flex;align-items:center;">
                                                    <img style="width:14px;height:15px;margin-right:6px;"
                                                         src="<?php echo base_url(); ?>assets/front/icons/calendar.svg"
                                                         alt="calendar"/>
...
<script>
    ...
    function showSlides() {
        ...
        if (slideIndex > 2) {
            slideIndex = 0;
        } // Changed condition (0-based indexing)
