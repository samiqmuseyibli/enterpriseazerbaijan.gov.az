<div  class="content_fullwidth less2">
	<div class="container">
		<div id="pencere" class="logregform two">
			...
			<div class="feildcont">
<?php echo form_open(base_url('user/update_estate'),array('role' => "form",'method'=>"post",'enctype'=>"multipart/form-data" ));?>
					...
					<div class="row">
						<div class="col-md-12 ">
							...
							<input type="text" name="project_name" id="projectName" required value="<?php echo $detail['project_title']; ?>"/>
						</div>
					</div>
                   <!-- Layihənin adı -->
                   ...
                   <!-- Qısa Məlumat -->
					<div class="row">
						...
						<textarea name="project_description" class="comment_textarea_bg" style=" width:100%; border: 1px solid #e3e3e3;" required><?php echo $detail['project_description']; ?></textarea></div>
					</div>
				   <!-- Qısa Məlumat -->
				   ...
				   <option value="2">Xüsusi mülkiyyət</option>
					...
					<!--Torpağın qiyməti -->  
					 ...
					 <div class="col-md-4 col-xs-12">
	                    ...
	                    <input type="text" name="infrastructure" id="projectName" required value="<?php echo $detail['infrastructure']; ?>" />
							</div>
    ...
    <div class="row">
		...
		<div class="col-md-12"><label for="project-info">Digər məlumatlar</label>
			<textarea name="project_other_info" class="comment_textarea_bg" style=" width:100%; border: 1px solid #e3e3e3;"><?php echo $detail['other_important_data']; ?></textarea>
	    </div>
		<!-- Digər məluamtlar -->  		
</div>
