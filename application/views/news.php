...
?>
	...
	<div class="page_title2 sty2">
		<div class="container">
			...
			<div class="pagenation">&nbsp;<a href="<?php echo base_url();?>"><?php echo translate('home_page');?></a> <i>/</i> <a href="<?php echo base_url();?>news"><?php echo translate('news');?></a></div>   
		</div>
	</div>
	<div class="clearfix"></div>
	<div id="sektorbase">      
								...
								<div class="col-md-4">
									<div class="box">
										...
										<div class="imgframe4" style="min-height: 250px; max-height: 260px; margin-bottom: 15px;" >
											<img src="<?php echo base_url('assets/front/images/news/');?><?php echo $item['url_image'];?> " alt="" style="max-width: 100%; max-height: 235px; " />
										</div>
