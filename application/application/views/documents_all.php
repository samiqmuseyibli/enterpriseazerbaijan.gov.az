   ...
   .item_title{
	...
	<div class="page_title2 sty2">
		<div class="container">
			...
			<div class="pagenation">&nbsp;<a href="<?php echo base_url($l);?>"><?php echo translate('home_page');?></a> <i>/</i> <a href="<?php echo base_url($l);?>/home/documents"><?php echo translate('doc_header');?></a></div>   
		</div>
	</div>
	<div class="clearfix"></div>
	<div id="sektorbase">      
				...
				<?php 
					if ($rows) {    
						foreach ($rows as $item) {?>  
							<a href="<?php echo base_url($l);?>/home/doc_detail/<?php echo $item['doc_id'];?>">
								<div class="row">
									<div class="doc_item">
