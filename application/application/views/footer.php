	...
	<div class="newsletter">
		<div class="container">
			...
			<!-- end section -->
			<div class="one_half last" id="subscribe">
				<?php echo $this->session->flashdata('update_datatable'); ?>
				<?php echo form_open(base_url($l.'/home/subscribe'), array('id' => "subscribe", 'method' => "post")); ?>
		...
		<div class="container">
			...
			<div class="one_fourth">
				<div class="qlinks">
					...
					<ul>
						<li><a href="<?php echo base_url($l); ?>/user/register" target="_blank"><i class="fa fa-angle-right"></i><?php echo translate('sign_up') ?></a></li>
						<li><a href="<?php echo base_url($l); ?>/user/login" target="_blank"><i class="fa fa-angle-right"></i><?php echo translate('login') ?></a></li>
					</ul>
				</div>
			</div>
			<div class="one_fourth">
					...
					<ul>
						<?php 
							...
							foreach ($categories as $category) { 
								?>
								<li>
									<a href="<?php echo base_url($l.'/project/category/'); ?><?php echo $category['kat_id'] . '-' . $category['kat_link']; ?>" target="_blank">
		...
		<div class="copyright_info">
			<div class="container">
				...
				<div class="one_half"> © | enterpriseazerbaijan.gov.az | <a
							href="<?php echo base_url($l.'/home/termsofuse'); ?>"><?php echo translate('Terms_of_Use'); ?></a> |
					<a href="<?php echo base_url($l.'/home/privacypolicy'); ?>"><?php echo translate('Privacy_Policy'); ?></a>
				</div>
...
<?php $success_message = $this->session->flashdata('succes_message'); if ($success_message): ?>
    <script>
        swal({
...
<?php $this->session->unset_userdata('succes_message'); endif; ?>
