...
<div class="page_title2 sty2">
	<div class="container">
		...
		<div class="pagenation">
			<a href="<?php echo base_url($l);?>"><?php echo translate('home_page');?></a> 
			<i>/</i> 
			<a href="<?php echo base_url($l);?>/news"><?php echo translate('news');?></a>
		</div>
	</div>
</div>
<div class="clearfix"></div>
		...
		<div class="content_left">       	
			<div class="blog_post">	
				<div class="blog_postcontent">
					<div class="image_frame"><a href="<?php echo base_url('assets/front/images/news/');?><?php echo $detail['url_image'];?>"><img style="object-fit: contain; max-height: 400px; border: 8px solid #fff; box-shadow: 0px 0px 4px 1px rgba(0,0,0,0.20);" src="<?php echo base_url('assets/front/images/news/');?><?php echo $detail['url_image'];?> " alt="<?=$detail['title_'.$l.'']?>" /></a></div>
					...
					<div class="share-post">
	                     <div class="sp-elements">
	                        ...
	                        <a target="_blank" href="https://telegram.me/share/url?url=<?=current_url()?>&text=<?=$detail['title_'.$l.'']?>">
				...
				<ul class="recent_posts_list">
					<?php foreach ($related as $item) {
						if($item['id'] != $detail['id']){
							?>
							<li>
								<span><a href="<?php echo base_url($l);?>/news/detail/<?php echo $item['id'].'-'.$item['top_'.$l.''];?>"><img class="imgframe2" style="max-width:80px" src="<?php echo base_url('assets/front/images/news/');?><?php echo $item['url_image'];?> " alt="" /></a></span>
								<a href="<?php echo base_url($l);?>/news/detail/<?php echo $item['id'].'-'.$item['top_'.$l.''];?>"><?php echo qisalt($item['title_'.$l.''],80) ?></a>
