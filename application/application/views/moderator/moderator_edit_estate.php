...
<div  class="content_fullwidth less2">
	<div class="container">
		<div id="pencere" class="logregform two">
			...
			<div class="feildcont">
	<?php echo form_open(base_url('moderator/edit_estate'),array('role' => "form",'method'=>"post",'enctype'=>"multipart/form-data" ));?>			
					...
					<div class="row">
						<div class="col-md-12 ">
							<label for="projectName" style="color: green">Layihənin adı(<?php echo $translation_row['lang_code']?>) <em>*</em></label>
							<input type="text" name="projectName_<?php echo $translation_row['lang_code']?>" id="projectName"  value="<?php echo $translation_row['project_title'];?>" required />
						</div>
					</div>
                   <!-- Layihənin adı -->
                  ...
                  <!-- Qısa Məlumat -->
					<div class="row">
						<div class="col-md-12"><label style="color: green" for="project-info">Qısa məlumat (<?php echo $translation_row['lang_code']?>)<em>*</em></label>
                               ...
                               <div class="row">
                                ...
                                <div class="row">
                                 ...
                                 <!--İnfrastruktur --> 
                                  <div class="row">
					 <div class="col-md-12">
						<label for="porject-sector">İnfrastruktur (<?php echo $translation_row['lang_code']?>)</label>                   
	         	<textarea name="infrastructure_<?php echo $translation_row['lang_code']?>" class="comment_textarea_bg" style=" width:100%; border: 1px solid #e3e3e3;"><?php echo $translation_row['infrastructure']; ?></textarea>
							</div>				 
						<!--İnfrastruktur --> 
						   </div>
                    ...
                    <!-- Mülkiyyət forması -->
                   <div class="col-md-6 col-xs-12">
	               <label for="porject-sector"><?php echo translate('property_form');?></label>                   
				...
				<!--Yerləşdiyi rayon  -->  
				 ...
				 <div class="col-md-6 col-xs-12">
					<label for="porject-sector"><?php echo translate('usage_form');?></label>                   
	            ...
	            <select>
		           <option value="">- Siyahıdan seçin -</option>
		           <option value="1">Dövlət mülkiyyəti</option>
				   <option value="2">Xüsusi mülkiyyət</option>
					...
					<!--Təyinatı   
					 ...
					 <div class="col-md-6 col-xs-12">
						...
						<input type="number" name="projectName" id="projectName" />
							</div>
