<div class="clearfix"></div>
    <div class="page_title2 sty2">
            <div class="container">
                ...
                <div class="pagenation">&nbsp;<a href="<?php echo base_url($l);?>"><?php echo translate('home_page');?></a><i> / </i><?php echo $detail['title_'.$l.''];?></div>
            </div>
        </div>
<style type="text/css">
    img{
                    ...
                    <div class="sidebar_widget">
                        ...
                        <ul class="arrows_list1">
                            <?php foreach ($items as $item) {
                                ...
                                ?>
                            <li><a <?php echo $active; ?> href="<?php echo base_url($l.'/home/doingbusiness/').$item['id'].'-'.$item['top'];?>"><i class="fa fa-angle-right"></i> <?php echo $item['title_'.$l.''];?></a></li>
                            <?php } ?>
                        </ul>
                    </div>
                </div>
