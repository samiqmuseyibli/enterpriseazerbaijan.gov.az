...
<div class="page_title2 sty2">
   <div class="container">
      ...
      <div class="pagenation">&nbsp;<a href="<?php echo base_url($l)?>"><?php echo translate('home_page');?></a> <i>/ </i> <a href="<?php echo base_url($l)?>/project/category/<?php echo $detail['kat_id'];?>"><?php echo $detail['kat_adi_'.$l.''];?></a></div>
   </div>
</div>
<div class="clearfix"></div>
            ...
            <div class="blog_postcontent">
               ...
               <div class="share-post">
                        <div class="sp-elements">
                           ...
                           <a target="_blank" href="https://telegram.me/share/url?url=<?=current_url()?>&text=<?=$detail['project_title']?>">
                              <div class="sp-element telegram"> <i class="sp-icons fa fa-telegram"> </i> <span class="sp-text mobileHide">Telegram</span></div>
                           </a>
                        </div>
                   </div>
               <ul>
                  <li class="post_by"><i class="fa fa-map-marker"></i> <strong><?php echo translate('Location_Project');?>:</strong> <a href="<?php echo base_url($l.'/geomap/');?>"><?php echo $detail['reg_adi_'.$l.'']?></a></li>
                  <?php
                     if ($detail['kat_id']==5) {
                     	echo null;
                     }else{
            ...
            <ul class="arrows_list1">	
               <?php
                  foreach ($category as $kat) {
                  	...
                  	echo '<li><a href="'.base_url($l.'/project/category/').''.$kat['kat_id'].'-'.$kat['kat_link'].'"><i class="fa fa-angle-right"></i>'.$kat['kat_adi_'.$l.''].'</a></li>';
                  }
                  ?>
            </ul>
         </div>
               ...
               <?php 
                  foreach ($related_projects as $related ) {
                  	...
                  	if ($related['project_id']!=$detail['project_id']) {
                  	   ...
                  	   echo'
                  			<li>
                  				<span><a href="'.base_url($l.'/project/detail/').''.$related['project_id'].'-'.$related['top'].'"><img class="imgframe2" src="'.$rimage.'" alt="'.$related['project_title'].'" style="width:90px ; height:70px;" /></a></span>
                  				<a href="'.base_url($l.'/project/detail/').''.$related['project_id'].'-'.$related['top'].'">'.qisalt($related['project_title'],55).'</a>
            ...
            <ul class="recent_posts_list">
               <?php
                  foreach($most_viewed as $viewed) {
                  	...
                  	echo'
                  		<li>
                  			<span><a href="'.base_url($l.'/project/detail/').''.$viewed['project_id'].'-'.$viewed['top'].'"><img class="imgframe2" src="'.$mimage.'" alt="'.$viewed['project_title'].'"  style="width:90px ; height:70px;" /></a></span>
                  			<a href="'.base_url($l.'/project/detail/').''.$viewed['project_id'].'-'.$viewed['top'].'">'.qisalt($viewed['project_title'], 55).'</a>
