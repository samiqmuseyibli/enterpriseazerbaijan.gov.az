<div class="content_fullwidth less2">
	<div class="container">
		<div id="pencere" class="logregform two">
			<div class="title">
				<h3><?php echo translate('Land_Sale');?></h3>
			</div>
			<div class="feildcont">
				<?php
				...
				echo form_open(base_url('user/addlandsale/doadd'),array('role' => "form",'method'=>"post",'enctype'=>"multipart/form-data" ));?>	
					<!-- Layihənin adı -->
					<div class="row">
						<div class="col-md-12 ">
					...
					<div class="row">
						<!--Təyinatı --> 
						<div class="col-md-6 col-xs-12">
							<label for="appointment"><?php echo translate('appointment');?> <em>*</em></label>                 

							<select name="appointment" id="appointment" required <?php echo form_error('appointment') != "" ? 'style="border: 1px solid #eb3535;"' : null; ?> >
								<option value="">- <?php echo translate('choose_one');?> -</option>
								<?php 
									foreach($appointment as $appointment_row) {
										?>
										<option value="<?php echo $appointment_row['appointment_id']; ?>" <?php echo $appointment_row['appointment_id'] == set_value('appointment') ? 'selected' : null; ?>>
											<?php echo $appointment_row['appointment_name_'.$l.'']; ?>
										</option>
										<?php
									}
								?>
						...
						<!--Ümumi Sahə --> 
						<div class="col-md-6 col-xs-12">
							<label for="ha"><?php echo translate('umumi_sahe');?> (ha) <em>*</em></label>
							<input type="number" name="ha" id="ha" min="1" required <?php echo form_error('ha') != "" ? 'style="border: 1px solid #eb3535;"' : null; ?> value="<?php echo set_value('ha'); ?>" />
						</div>
						<!--Ümumi Sahə --> 
					</div>
