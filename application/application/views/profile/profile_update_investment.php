<div class="content_fullwidth less2">
	<div class="container">
		<div id="pencere" class="logregform two">
			...
			<div class="feildcont">
				<?php echo form_open(base_url($l.'/user/update_investment'),array('role' => "form",'method'=>"post",'enctype'=>"multipart/form-data" ));?>	
				...
				<!--Investisiya hecmi -->  
				 ...
				 <div class="col-md-12 col-xs-12">
						<label for="projectName">Layihənin üstünlükləri</label>
						<textarea name="main_advantages" class="comment_textarea_bg" style=" width:100%; border: 1px solid #e3e3e3;" ><?php echo $detail['main_advantages']; ?></textarea></div>
						</div>
    ...
    <div class="row">
		...
		<div class="col-md-12"><label for="project-info">Digər məlumatlar</label>
			<textarea name="project_other_info" class="other_important_data" style=" width:100%; border: 1px solid #e3e3e3;"><?php echo $detail['other_important_data']; ?></textarea>
	    </div>
		<!-- Digər məluamtlar -->  		
</div>
...
<div class="row">
	            <!-- Unvan -->  	
	             <div class="col-md-6">
		            ...
		            <input type="text" name="address"  required value="<?php echo $detail['adress']; ?>" />
	             </div>
                <!-- Unvan -->  
