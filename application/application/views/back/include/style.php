...
<link rel="stylesheet" href="<?php echo base_url('assets/back/'); ?>dist/css/AdminLTE.min.css">  <!-- Top tab Icon -->
...
<link rel="stylesheet" href="<?php echo base_url('assets/back/'); ?>imagedelete.css">
