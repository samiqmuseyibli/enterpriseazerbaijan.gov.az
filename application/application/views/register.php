	...
	<div class="page_title2 sty2">
		<div class="container">
			...
			<div class="pagenation">&nbsp;<a href="<?php echo base_url($l);?>"><?php echo translate('home_page');?></a> <i>/</i> <?php echo translate('register');?></div> 
		</div>
	</div><!-- end page title -->
		...
		<div class="container">
			<div class="logregform two">
				<div class="title">
					...
					<p><?php echo translate('do_you_have_account');?> &nbsp;<a style="color:#cf000f" href="<?php echo base_url($l.'/user/login'); ?>"><?php echo translate('okey_login_now');?></a></p>
				</div>
				<div class="feildcont">
					<?=form_open(base_url($l.'/user/register_user'),array('role' => "form",'method'=>"post"));?> 
						...
						<div>
							<small style="color: red;"> <?php echo translate('note_for_password');?></small>
						</div>
						...
						<label for="agree"><span style="font-size: 15px;"><?php echo translate('I accept terms and');?></span><a style="color:#cf000f; font-size: 15px;" href="<?php echo base_url($l.'/home/termsofuse');?>"><?php echo translate('conditions');?></a></label>
