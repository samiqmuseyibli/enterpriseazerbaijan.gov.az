...
<div class="page_title2 sty2">
	<div class="container">
		...
		<div class="pagenation">&nbsp;<a href="<?php echo base_url($l);?>"><?php echo translate('home_page');?></a> <i>/ </i><?php echo translate('contact');?></div>
	</div>
</div><!-- end page title -->
<div class="clearfix"></div>
	...
	<div class="container">
		<div class="one_half">
			<div class="cforms_sty3">
				...
				<?php echo form_open(base_url($l.'/home/message'),array('id' => "gsr-contact",'method'=>"post",'onSubmit'=>"return valid_datas( this );" ));?>
