<?php
	...
	class Project extends CI_Controller{
		...
		public function all(){
			...
			$config                      = array();
			$config["base_url"]          = base_url() . "project/all";
		...
		public function category(){		 
			...
			if (is_numeric($category_id) and $category_id !=0 ){			
				...
				$pagedata['categories']      = $this->project_model->get_categories();
				$config                      = array();
				$config["base_url"]          = base_url() . "project/category/" . $this->uri->segment(3, 0);
		...
		public function filter(){
			...
			$config                      = array();
			$config["base_url"]          = base_url() . "project/filter/?sector=" . $sector . "&region=" . $region . "&category=" . $category . "&cost_option=" . $cost_option . "";
